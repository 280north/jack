...
Request.prototype.body            = function() { return this.env.body;                };
...
Request.prototype.POST = function() {
    ...
    // TODO: implement hasFormData
        ...
        this.env["jack.request.form_input"] = this.env.body;
        this.env["jack.request.form_hash"] = utils.parseMultipart(this.env);
        if (!this.env["jack.request.form_hash"]) {
            this.env["jack.request.form_vars"] = this.env.body.read().decodeToString("utf-8");

...
var Narwhal = exports.Narwhal = function(env) {
    var req = new Request(env),
        narwhal = "",
        href = "";

    if (req.GET("narwhals")) {
        narwhal = Narwhal.NARWHALS_FLASH;
    }
    else if (req.GET("flip") === "crash") {
        throw new Error("Narwhal crashed");
    }
    else if (req.GET("flip") === "left") {
        narwhal = Narwhal.NARWHAL_LEFT;
        href = "?flip=right";
    }
    else {
        narwhal = Narwhal.NARWHAL_RIGHT;
        href = "?flip=left";
    }

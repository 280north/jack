...
exports.responseForStatus = function(code, optMessage) {
    if (exports.HTTP_STATUS_CODES[code] === undefined)
        throw "Unknown status code";
    
    var message = exports.HTTP_STATUS_CODES[code];
    ...
    return [code, { "Content-Type" : "text/plain", "Content-Length" : String(body.length) }, [body]];
}
        ...
        while (true) {
            var head = null,
                body = {
                    ...
                    decodeToString : function() { return this._buffer.join(""); }
                },
                filename = null,
                contentType = null,
                name = null,
